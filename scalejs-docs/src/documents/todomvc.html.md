...
This tutorial is created using scalejs v0.3.5. You can view and clone this application from [this repository.](https://github.com/egucciar/todomvc/tree/scalejs/labs/architecture-examples/scalejs/ToDoMVC) (scalejs branch)
...
which is explained in more details [here](./template.html).  
...
This folder contains the [modules](./modules.html) for your project. 
...
The main module is responsible for the overall application [layout](./layout.html), setting up routing, and 
...
After this change, our app now looks like this.

![Bare bones and boring](./scalejs_mainview_edit1.png)
...
more about the [sandbox](./sandbox.html) and the [mvvm extension](./mvvm.html)
in our docs. 
